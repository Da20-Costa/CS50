...
def index():
    ...
    # define the values that will be shown
    for stock in stocks:
...
def buy():
    if request.method == "POST":
        ...
        # update transactions
        db.execute("INSERT INTO transactions (user_id, symbol, shares, price, type) VALUES (?, ?, ?, ?, 'purchase')",
        ...
        for stock in stocks:
            if stock["symbol"] == symbol:
                ...
                if stock["total_shares"] < shares:
                    ...
                    # update transactions
                    db.execute("INSERT INTO transactions (user_id, symbol, shares, price, type) VALUES (?, ?, ?, ?, 'sale')",
                               session["user_id"], symbol, shares, price)
